...
func (ms *MSSQL) connect() (*sqlmw.DB, error) { _ = "STUB: not implemented"; return nil, nil }

func (ms *MSSQL) connectionCredentials() *credentials { _ = "STUB: not implemented"; return nil }
...
func (ms *MSSQL) TestFetchSchema(ctx context.Context) error { _ = "STUB: not implemented"; return nil }

func (ms *MSSQL) SetConnectionTimeout(timeout time.Duration) { _ = "STUB: not implemented"; return }

func (*MSSQL) ErrorMappings() []model.JobError { _ = "STUB: not implemented"; return nil }
